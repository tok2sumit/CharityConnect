...
$insert= "insert into feedback values('$mail','$feed')";
...
?>
 ...
 <header class="header">
          ...
          <div class="header__sm-menu-content">
            <ul class="header__sm-menu-links">
              <li class="header__sm-menu-link">
                <a href="Donor_feedback.php"  class="btn btn-info">Home</a>
              </li>
              <li class="header__sm-menu-link">
    ...
    <input type="email" placeholder="Email-id" name="email" id="email" class="input1" required></input>
                <textarea name="feed" id="feed" cols="30" rows="10" class="input1" placeholder="Write here...."></textarea>
              
            <button type="submit" name="submit" class="input1">Submit</button>
