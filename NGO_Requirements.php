...
$insert= "insert into requirements values('$ename','$edesc','$edate','$ereq')";
...
<header class="header">
      ...
      <div class="heading">
        <h1>NGO - Post your Requirements</h1>
      </div>
     



    <form class="box" autocomplete="off" enctype="multipart/form-data" method="POST">

                <input type="text" name="ename" placeholder="Name" class="input1">
     
                <textarea name="edesc" id="" cols="30" rows="10" class="input1" placeholder="Event Description"></textarea>
 
                <input type="date"  name ="edate" class="input1" placeholder="Event Date">

                <input type="number" name="ereq" placeholder="Required Amount in Ruppes" class="input1">

                 <button type="submit" name="submit" class="input1">Request</button>
        </div>
    </form>
