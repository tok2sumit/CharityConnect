      ...
      <div class="row">
        <div class="col-md-4 col-xl-4">
          <div class="card bg-c-blue order-card">
            <div class="card-block">
              <h6 class="m-b-20"> <a href="admin_view_NGO.php" style="text-decoration: none; margin-left: 14px;" class="btn btn-primary">Total NGO</a> </h6>
              <h2 class="text-right" style="margin-right: 82%;"><i class="fas fa-chalkboard-teacher f-left"></i><span> <?php echo $total; ?> </span></h2>
        ...
        <div class="col-md-4 col-xl-4">
          <div class="card bg-c-green order-card">
            <div class="card-block">
              <h6 class="m-b-20"><a href="admin_view_pending_NGO.php" style="text-decoration: none; margin-left: 14px;" class="btn btn-primary">Total Pending NGO</a> </h6>
              <h2 class="text-right"style="margin-right: 72%;"><i class="fas fa-spinner f-left"></i><span> <?php echo $total2; ?> </span></h2>
