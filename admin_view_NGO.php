        ...
        <div class="panel panel-primary">
          ...
          <table class="table table-hover" id="dev-table">
            ...
            <tr>
              ...
              <form action ="admin_view_NGO.php" method ="POST">
              <input type = "hidden" name  ="id" value = "<?php echo $row['id'];?>"/>
             <td> <input type = "submit" class="btn btn-danger btn-xs" style="height: 40px; width: 60px;"  name ="deny" value = "Delete"/></td>
            </form>
...
if(isset($_POST['deny'])){
    ...
    echo 'alert("Donor deleted!");';
    echo 'window.location.href = "admin_view_NGO.php"';
    echo '</script>';
}
?>
