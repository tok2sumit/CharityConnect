...
<head>
    ...
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-2BPBCBNRJY"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-2BPBCBNRJY');
</script>
...
<body>
    <div class="wrapper">
            ...
            <div class="header__content">
              ...
              <div class="header__main">
                <ul class="header__links">
                  ...
                  <li class="header__link-wrapper">
                    <a href="Reg_Login.html" class="header__link"> join-us Now </a>
                  </li>
            ...
            <div class="header__sm-menu">
              <div class="header__sm-menu-content">
                <ul class="header__sm-menu-links">
                  ...
                  <li class="header__sm-menu-link">
                    <a href="Reg_Login.html"> join-us Now </a>
                  </li>
                </ul>
              </div>
            </div>
                        ...
                        <div class="client owl-carousel owl-theme">
                            <div class="item">
                                <div class="text">
                                    ...
                                    <h5 class="white-button"><a href="Donorlogin.php">DONATE NOW</a></h5>
                                    <h5><a href="Donorlogin.php">CONTACT US</a></h5>
                                </div>
                            </div>
                            <div class="item">
                                <div class="text">
         ...
         <section class="events_section_area">
           <section class="our_activity">
            <div style="width: 300px; margin-left: 42%;">
                <h2 style="text-align: center; margin-top: 52px; border-bottom: 3.5px solid green ;">UPCOMING EVENTS</h2>
            </div>
        ...
        <footer class="footer">
            ...
            <div class="footera_bottom">
                <p style="text-align: center;">Copyright @ 2021 <a href="#">CharityConnect</a> | All Rights Reserved </p>
            </div>
        </footer>
    </div>
